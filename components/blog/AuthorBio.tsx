      ...
      <div className="flex flex-col md:flex-row items-center md:items-start">
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <div className="mt-4 flex justify-center md:justify-start space-x-3">
            <a 
              href="#" 
              className="w-10 h-10 rounded-full flex items-center justify-center text-gray-600 hover:text-blue-600 border border-gray-300 hover:border-blue-600 transition-colors"
              aria-label="Twitter"
            >
