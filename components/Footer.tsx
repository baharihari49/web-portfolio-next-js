  ...
  return (
    <footer className="bg-gradient-to-br from-indigo-600 via-blue-700 to-indigo-800 text-white pt-20 pb-8 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex space-x-3">
              <a 
                ...
                target="_blank" 
                rel="noreferrer" 
                className="w-10 h-10 rounded-full bg-white hover:bg-gray-200 text-blue-600 flex items-center justify-center transition-colors duration-300"
                aria-label="GitHub"
              >
        ...
        {/* Footer divider */}
        <div className="h-px bg-gradient-to-r from-transparent via-gray-500 to-transparent mb-8"></div>
